...
leg=legend('Original PDF','PDF fixing \itRH\rm\bf=16','PDF fixing \itRH\rm\bf=18','PDF fixing \itRH\rm\bf=20','PDF fixing \itRH\rm\bf=22','PDF fixing \itRH\rm\bf=24');
...
leg=legend('Original CDF','CDF fixing \itRH\rm\bf=16','CDF fixing \itRH\rm\bf=18','CDF fixing \itRH\rm\bf=20','CDF fixing \itRH\rm\bf=22','CDF fixing \itRH\rm\bf=24');
set(leg,'Location','northeast','fontsize',fosize,'fontname','Times New Roman','FontWeight','bold');
set(gca, 'fontsize',fosize,'fontname','Times New Roman');
set(gcf,'unit','centimeters','position',[10 5 20 15]);
xlabel('\itR','FontWeight','bold','FontWeight','bold','fontsize',fosize,'fontname','Times New Roman');
