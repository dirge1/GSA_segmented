...
leg=legend('Original PDF','PDF fixing \itT\rm\bf=17','PDF fixing \itT\rm\bf=21','PDF fixing \itT\rm\bf=25','PDF fixing \itT\rm\bf=29','PDF fixing \itT\rm\bf=33                ');
...
leg=legend('Original CDF','CDF fixing \itT\rm\bf=17','CDF fixing \itT\rm\bf=21','CDF fixing \itT\rm\bf=25','CDF fixing \itT\rm\bf=29','CDF fixing \itT\rm\bf=33                ');
set(leg,'Location','northeast','fontsize',fosize,'fontname','Times New Roman','FontWeight','bold');
set(gca, 'fontsize',fosize,'fontname','Times New Roman');
set(gcf,'unit','centimeters','position',[10 5 20 15]);
xlabel('\itR','FontWeight','bold','FontWeight','bold','fontsize',fosize,'fontname','Times New Roman');
