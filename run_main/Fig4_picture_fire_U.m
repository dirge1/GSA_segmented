...
leg=legend('Original PDF','PDF fixing \itU\rm\bf=3.7','PDF fixing \itU\rm\bf=4.2','PDF fixing \itU\rm\bf=4.7','PDF fixing \itU\rm\bf=5.2','PDF fixing \itU\rm\bf=5.7');
...
leg=legend('Original CDF','CDF fixing \itU\rm\bf=3.7','CDF fixing \itU\rm\bf=4.2','CDF fixing \itU\rm\bf=4.7','CDF fixing \itU\rm\bf=5.2','CDF fixing \itU\rm\bf=5.7');
set(leg,'Location','northeast','fontsize',fosize,'fontname','Times New Roman','FontWeight','bold');
set(gca, 'fontsize',fosize,'fontname','Times New Roman');
set(gcf,'unit','centimeters','position',[10 5 20 15]);
xlabel('\itR','FontWeight','bold','FontWeight','bold','fontsize',fosize,'fontname','Times New Roman');
